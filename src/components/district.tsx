     ...
     return(
        ...
        <>
             ...
             <div className="md:hidden relative w-full h-[100vh] overflow-hidden">
                 ...
                 <button onClick={()=>{navigate("/state")}}>   <img className="absolute top-0 left-0 m-4" src={left}></img> </button>
                 ...
                 <div className="w-full ml-4 justify-center mt-4 grid grid-cols-2 gap-8 ">
                  {
                     districts.map((item:string) =>(
                           ...
                           <button  onClick={()=>{setOn(1)}} className="rounded-lg relative   bg-red-600 px-6 py-2 font-bold text-white focus:bg-red-900 "><img className='absolute left-0 ml-2' src={loc}></img>{item}</button>
                 ...
                 {
                    on?
                 <button onClick={()=>{navigate("/welcome")}}  className=" z-10 rounded-lg px-8 py-2 bg-green-500 text-white w-40 mt-4 text-2xl">continue</button>
                 :
                 <></>
                 }
